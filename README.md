...
This repository also holds **Universe**, a separate app — a companion for WWE
2K25's Universe Mode. The two share only build and test tooling; Universe is
documented in [UNIVERSE.md](UNIVERSE.md) and opens from `dist/universe.html`.
